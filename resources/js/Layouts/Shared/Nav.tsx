    ...
    return (
        <>
            <form action="#" className="search-box">
                <button
                    type="button"
                    className="search-box__close absolute inset-block-start-0 right-0 m-16 w-48 h-48 border border-gray-100 rounded-[50%] flex items-center justify-center text-white hover-text-gray-800 hover-bg-white text-2xl transition-1"
                >
                ...
                <div className="container">
                    <div className="relative">
                        <input
                            className="form-control block w-full p-[0.375rem_0.75rem] leading-6 text-[#495057] bg-white bg-clip-padding border border-[#ced4da] transition-all duration-150 ease-in-out focus:text-[#495057] focus:bg-white focus:border-main focus:outline-0 focus:shadow-none py-16 px-24 text-xl rounded-[50rem] pe-64 h-[64px]"
                            placeholder="Search for a product or brand"
                        />{" "}
                        <button
                            type="submit"
                            className="w-48 h-48 bg-main-600 rounded-[50%] flex items-center justify-center text-xl text-white absolute top-[50%] translate-y-[-50%] right-0 me-8"
                        >
                        ...
                        <ul className="header-top__right flex items-center flex-wrap">
                            <li className="on-hover-item border-right-item border-right-item-sm-space has-submenu arrow-white">
                                ...
                                <ul className="on-hover-dropdown common-dropdown common-dropdown--sm max-h-200 scroll-sm px-0 py-8">
                                    <li className="nav-submenu__item">
                                        <a
                                            href="index.html"
                                            className="nav-submenu__link hover-bg-gray-100 text-gray-500 text-xs py-6 px-16 flex items-center gap-8 rounded-none"
                                        >
                            ...
                            <li className="border-right-item">
                                {!usePage().props.auth.user ? (
                                    <Link
                                        href="/login"
                                        className="text-white text-sm py-8 flex items-center gap-6"
                                    >
                    ...
                    <nav className="header-inner flex-between">
                        ...
                        >
                            <div className="search-category flex h-48 select-border-r-0 radius-end-0 search-form md:flex hidden">
                                <select
                                    className="js-example-basic-single border border-gray-200 border-r-0"
                                    name="state"
                                >
                                ...
                                <div className="search-form__wrapper relative">
                                    <input
                                        className="search-form__input common-input py-13 ps-16 pe-18 !rounded-tr-[50rem] !rounded-br-[50rem] pe-44"
                                        placeholder="Search for a product or brand"
                                    />{" "}
                                    <button
                                        type="submit"
                                        className="w-32 h-32 bg-main-600 rounded-[50%] flex items-center justify-center text-xl text-white absolute top-[50%] translate-y-[-50%] right-0 me-8"
                                    >
                                        <i className="ph ph-magnifying-glass"></i>
                                    </button>
                                </div>
                            ...
                            <div className="location-box bg-white flex items-center gap-8 py-6 px-16 rounded-[50rem] border border-gray-100">
                                <span className="text-gray-900 text-xl sm:flex hidden">
                        ...
                        <div className="header-right items-center xl:block hidden">
                            <div className="flex items-center flex-wrap gap-12">
                                <button
                                    type="button"
                                    className="search-icon flex items-center xl:hidden flex gap-4 item-hover"
                                >
                                    <span className="text-2xl text-gray-700 flex relative item-hover__text">
                                        <i className="ph ph-magnifying-glass"></i>
                                    </span>
                                </button>{" "}
                                <a
                                    href="cart.html"
                                    className="flex items-center gap-4 item-hover"
                                >
                                    <span className="text-2xl text-gray-700 flex relative me-6 mt-6 item-hover__text">
                                        <i className="ph ph-heart"></i>{" "}
                                        <span className="w-16 h-16 flex items-center justify-center rounded-[50%] bg-main-600 text-white text-xs absolute top-n6 end-n4">
                                            2
                                        </span>{" "}
                                    </span>
                                    <span className="text-md text-gray-500 item-hover__text hidden xl:flex">
                                        Wishlist
                                    </span>{" "}
                                </a>
                                <a
                                ...
                                >
                                    <span className="text-2xl text-gray-700 flex relative me-6 mt-6 item-hover__text">
                                        <i className="fluent--chat-20-regular-simple"></i>{" "}
                                        <span className="w-16 h-16 flex items-center justify-center rounded-[50%] bg-main-600 text-white text-xs absolute top-n6 end-n4">
                                            2
                                        </span>{" "}
                                    </span>
                    ...
                    <nav className="header-inner flex justify-between gap-8">
                        <div className="flex items-center menu-category-wrapper">
                            <div className="category on-hover-item">
                                <button
                                    type="button"
                                    className="category__button flex items-center gap-8 font-[500] p-16 border-r border-l border-gray-100 text-heading"
                                >
                        ...
                        <div className="header-right flex items-center">
                            <a
                                ...
                                className="bg-main-600 text-white p-12 h-full hover-bg-main-800 flex items-center gap-8 text-lg xl:flex hidden"
                            >
                                <div className="flex text-32">
