...
export default function AdminStoreCard({ store }: StoreCardProps) {
  ...
  return (
    <div className="relative flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md dark:border-gray-700 dark:bg-gray-800 dark:text-white">
        ...
        <Link href={route(`dashboard.products.index`, {store:store.slug})} className="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
        {/* <BaggageClaim /> */}
        View Products</Link>
        </div>
        </div>
