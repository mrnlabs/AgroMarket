  ...
  return (
    <Authenticated>
        <div className="flex justify-between items-center">
                    <h4 className="text-slate-900 dark:text-slate-200 text-lg font-medium">Mazisi Products</h4>

                    <div className="md:flex hidden items-center gap-2.5 text-sm font-semibold">
                        <div className="flex items-center gap-2">
                            <a href="#" className="text-sm font-medium text-slate-700 dark:text-slate-400">Konrix</a>
                        </div>

                        <div className="flex items-center gap-2">
                            <i className="mgc_right_line text-lg flex-shrink-0 text-slate-400 rtl:rotate-180"></i>
                            <a href="#" className="text-sm font-medium text-slate-700 dark:text-slate-400">Components</a>
                        </div>

                        <div className="flex items-center gap-2">
                            <i className="mgc_right_line text-lg flex-shrink-0 text-slate-400 rtl:rotate-180"></i>
                            <a href="#" className="text-sm font-medium text-slate-700 dark:text-slate-400" aria-current="page">Card</a>
                        </div>
                    </div>
                </div>
