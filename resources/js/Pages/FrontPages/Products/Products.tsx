                    ...
                    <div className="row">
                        <div className="xl:w-3/12 flex-grow-0 flex-shrink-0 basis-auto">
                            <div className="shop-sidebar">
                                <button
                                    type="button"
                                    className="shop-sidebar__close xl:hidden flex w-32 h-32 items-center justify-center border border-gray-100 rounded-full hover-bg-main-600 absolute right-0 mr-[10px] mt-8 hover-text-white hover-border-main-600"
                                >
                                    <i className="ph ph-x"></i>
                                </button>
                                {/* Category Box */}
                                <div className="shop-sidebar__box border border-gray-100 rounded-8 p-32 mb-32">
                                    <h6 className="text-xl border-b border-gray-100 pb-24 mb-24">
                                        Product Category
                                    </h6>
                                ...
                                <div className="shop-sidebar__box border border-gray-100 rounded-8 p-32 mb-32">
                                    ...
                                    <div className="custom--range">
                                        ...
                                        <div className="flex-between flex-wrap-reverse gap-8 mt-24">
                                            <button
                                                type="button"
                                                className="btn btn-main h-40 flex items-center"
                                            >
                                                Filter
                                            </button>
                                ...
                                <div className="shop-sidebar__box border border-gray-100 rounded-8 p-32 mb-32">
                                    ...
                                    <ul className="max-h-540 overflow-y-auto scroll-sm">
                                        {[
                                            ...
                                            >
                                                <div
                                                    className={`form-check common-check common-radio ${item.class}`}
                                                >
                                                    <input
                                                        className="form-check-input"
                                                        type="radio"
                            ...
                            <div className="flex-between gap-16 flex-wrap mb-40">
                                ...
                                <div className="relative flex items-center gap-16 flex-wrap">
                                    <div className="list-grid-btns flex items-center gap-16">
                                        <button
                                            type="button"
                                            className="w-44 h-44 flex items-center justify-center border border-gray-100 rounded-6 text-2xl list-btn"
                                        >
                                            <i className="ph-bold ph-list-dashes"></i>
                                        </button>
                                        <button
                                            type="button"
                                            className="w-44 h-44 flex items-center justify-center border border-main-600 text-white bg-main-600 rounded-6 text-2xl grid-btn"
                                        >
                                    ...
                                    <button
                                        type="button"
                                        className="w-44 h-44 xl:hidden flex items-center justify-center border border-gray-100 rounded-6 text-2xl sidebar-btn"
                                    >
