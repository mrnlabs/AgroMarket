...
import { Plus, File, X, Image as ImageIcon } from 'lucide-react';
    ...
    <div className={`space-y-4 ${className}`}>
      ...
      >
        <div className="flex flex-col items-center justify-center min-h-[10rem] text-gray-500">
          {multiple ? <Plus className="w-12 h-12 mb-4" /> : <ImageIcon className="w-12 h-12 mb-4" />}
          ...
          {selectedFiles.map((file, index) => (
            ...
            >
              ...
              <div className="flex flex-col items-center gap-2">
                {renderPreview(file)}
                <p className="text-sm text-center text-gray-600 truncate w-full">
                  {file.name}
                </p>
