...
const ProductCard = ({product} : ProductCardProps) => {
  ...
  return (
    ...
    <div className="product-card px-8 py-16 border border-gray-100 hover-border-main-600 rounded-16 relative transition-2">
       <Link   href={route('products.show', { id: product.slug })}  className="product-card__cart btn bg-main-50 text-main-600 hover-bg-main-600 hover-text-white py-11 px-24 rounded-[50rem] flex items-center gap-8 absolute inset-block-start-0 right-0 me-16 mt-16">Add <i className="fluent--chat-20-regular"></i> </Link>
       <Link   href={route('products.show', { id: product.slug })}   className="product-card__thumb flex items-center justify-center">
       ...
       <div className="product-card__content mt-12">
          ...
          <h6 className="title text-lg font-[600] mt-12 mb-8"><Link   href={route('products.show', { id: product.slug })}  className="link text-line-2">{product.title}</Link></h6>
